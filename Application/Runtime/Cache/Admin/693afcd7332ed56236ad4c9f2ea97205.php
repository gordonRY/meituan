...
<!--产品与服务LAN-->
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown li-border">
                <a href="#" class="dropdown-toggle mystyle-color" data-toggle="dropdown">产品与服务<span class="caret"></span></a>
        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown li-border"><a href="#" class="dropdown-toggle mystyle-color" data-toggle="dropdown">您好，<?php echo ($admin["admin_name"]); ?><span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="<?php echo U('public/logout');?>" onclick="return confirm('确定退出系统？')">退出</a></li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="down-main">
        <div class="left-main left-full">
            ...
            <div class="subNavBox">
    <?php if(is_array($sidebar_far)): foreach($sidebar_far as $key=>$vo): ?><div class="sBox">
            <div class="subNav sublist-down">
                <span class="title-icon glyphicon glyphicon-chevron-right"></span>
                <span class="sublist-title"><?php echo ($vo["name"]); ?></span>
            </div>
            <ul class="navContent" style="display:none">
                <?php if(is_array($sidebar_son)): foreach($sidebar_son as $key=>$n): if($n['fid']==$vo['id']): ?><li class="nav-li">
                        <div class="showtitle" style="width:100px;">
                            <img src="/Thinkphp_meddle/b2b2c/Public/Admin/images/leftimg.png" /><?php echo ($n["name"]); ?>
                        </div>
                        <a href="<?php echo U($n['mca']);?>" target="right_content">
                            <span class="sublist-icon glyphicon glyphicon-record"></span>
                            <span class="sub-title"><?php echo ($n["name"]); ?></span>
                        </a> 
