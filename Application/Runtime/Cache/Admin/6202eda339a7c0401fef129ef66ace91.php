    ...
    <div class="info-center">
        ...
        <div class="table-margin">
            <form action="" class="form-horizontal" method="post">
                <input type="hidden" name="admin_id" value="<?php echo ($user_data['admin_id']); ?>">
                <table class="table table-hover contact-template-form">
                    <tbody>
                        <tr>
                            <td width="20%" align="right">管理组：</td>
                            <td>
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="radio radio-info radio-inline">
		                        <input type="radio" id="<?php echo ($v["title"]); ?>" value="<?php echo ($v["gid"]); ?>" name="group_ids"  <?php echo ($group_data==$v['gid']?checked:''); ?>>
                        ...
                        <tr>
                            <td width="20%" align="right">登陆密码：</td>
                            <td>
                                <input class="form-control w-300 pull-left" type="password" name="admin_password"><span class="tip-text">如不改密码；留空即可</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><span class="inputword">允许登录</span> <input class="xb-icheck" type="radio" name="status" value="1" <?php if(($user_data['status']) == "1"): ?>checked="checked"<?php endif; ?> ></label> &emsp; <label><span class="inputword">禁止登录</span> <input class="xb-icheck" type="radio" name="status" value="0" <?php if(($user_data['status']) == "0"): ?>checked="checked"<?php endif; ?> ></label>
                            </td>
                        </tr>
                        <tr>
                            <tD></td>
