	...
	<form class="form form-horizontal" id="form-article-add" action="<?php echo U('Admin/Product/addProduct?pid=$m.p_id');?>" name="form" method='post' enctype='multipart/form-data'>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($m["p_rname"]); ?>" placeholder="" name="rname">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<!-- 三级联动 开始 -->
			<!--省份-->
			<input name='prov'type="hidden" value="<?php echo ($m["p_provid"]); ?>">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:200px">
				...
				<select name="city" class="select">
					<option value="<?php echo ($m["p_cityid"]); ?>" selected><?php echo ($m["p_cityname"]); ?></option>
				</select>
				</span>
			</div>
			<!--区县-->
			<div class="formControls col-xs-8 col-sm-9" style="width:200px;">
				...
				<select name="county" class="select">
					<option value="<?php echo ($m["p_counid"]); ?>" selected><?php echo ($m["p_counname"]); ?></option>
				</select>
				</span>
			</div>
			<!-- 三级联动 结束 -->
		...
		<div class="row cl">
			...
			<?php else: ?>
				...
				<input type="hidden" name="theme_edit" value="<?php echo ($m["p_theme"]); ?>"><?php endif; ?>
		<input type="hidden" name="p_id" value="<?php echo ($m["p_id"]); ?>">
		<div class="row cl">
			...
			<?php if($m['p_pic']!=''): ?><div class="row cl">
				...
				<label class="form-label col-xs-4 col-sm-2">上次图片：</label>
					...
					<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><img src="/Thinkphp_meddle/b2b2c/Public/<?php echo ($v); ?>" alt=""
						...
						<input type="hidden" name="pic_edit[]" value="<?php echo ($v); ?>" ><?php endforeach; endif; ?>
...
<script>
    $(document).on('ready', function() {
        $("#rex_theme").fileinput({showCaption: false});
    });
