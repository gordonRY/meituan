...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Thinkphp_meddle/b2b2c/Public/Checkboxes/css/awesome-bootstrap-checkbox.css" />
	<link rel="stylesheet" type="text/css" href="/Thinkphp_meddle/b2b2c/Public/Checkboxes/css/font-awesome.min.css" />
...
<div id="bdw" class="bdw">
	<div id="bd" class="cf">
		...
		<form action="<?php echo U('Home/Index/comment_info');?>" method="post">
<div class="comment_main">

	<div style="display:inline-block;border:0px solid red">

		<a href=""><img src="/Thinkphp_meddle/b2b2c/Public/<?php echo ($m["p_theme"]); ?>" alt="" class="pic_comment"></a>
	</div>
	<div style="display:inline-block;border:0px solid red;height:90px;position:relative;top:-6px">
		<div  style="margin-top:20px;font-weight: bold ">商品名称：<a href="" style="color:blue"><?php echo mb_substr($m['p_name'],0,17,'utf-8');?></a></div>
		<div style="margin-top:20px ;font-weight: bold">我的评分：
			<div class="radio radio-info radio-inline">
				<input type="radio" id="inlineRadio1" value="1" name="radioInline[]" checked="">
				<label for="inlineRadio1"> 差的一笔 </label>
			</div>

			<div class="radio radio-info radio-inline">
				<input type="radio" id="inlineRadio2" value="3" name="radioInline[]" checked="">
				<label for="inlineRadio2"> 一般 </label>
			</div>

			<div class="radio radio-info radio-inline">
				<input type="radio" id="inlineRadio3" value="3" name="radioInline[]" checked="">
				<label for="inlineRadio3"> 满意 </label>
			</div>

			<div class="radio radio-info radio-inline">
				<input type="radio" id="inlineRadio4" value="4" name="radioInline[]" checked="">
				<label for="inlineRadio4"> 很满意 </label>
			</div>


			<div class="radio radio-info radio-inline">
				<input type="radio" id="inlineRadio5" value="5" name="radioInline[]" checked="">
				<label for="inlineRadio5"> 强烈推荐 </label>
			</div>


			<span style="color:orangered"></span></div>
	</div>
	<div >
		<div class="my_comment">我的评论：</div>
		<textarea name="comment" id="my_comment" cols="60" rows="3" ></textarea>
</div>
	</div>
			<button type="submit" class="btn btn-info go_comment">评价</button>
			<input type="hidden" name="pid" value="<?php echo ($m['p_id']); ?>">
			<input type="hidden" name="oid" value="<?php echo ($m['o_id']); ?>">
		</form>
