...
<div class="comment_main">
	...
	<div style="display:inline-block;border:0px solid red">
		...
		<a href=""><img src="/Thinkphp_meddle/b2b2c/Public/<?php echo ($p_theme); ?>" alt="" class="pic_comment"></a>
	</div>
	<div style="display:inline-block;border:0px solid red;height:90px;position:relative;top:-6px">
		<div  style="margin-top:20px;font-weight: bold ">商品名称：<a href="" style="color:blue"><?php echo mb_substr($p_name,0,17,'utf-8');?></a></div>
		<div style="margin-top:20px ;font-weight: bold">我的评分：
			<?php if($msg['star']==1): ?><span style="color:orange;font-weight: bold">差的一笔</span>
				<?php elseif($msg['star']==2): ?>
				<span style="color:orange;font-weight: bold">just so so</span>
				<?php elseif($msg['star']==3): ?>
				<span style="color:orange;font-weight: bold">满意</span>
				<?php elseif($msg['star']==4): ?>
				<span style="color:orange;font-weight: bold">很满意</span>
				<?php elseif($msg['star']==5): ?>
				<span style="color:orange;font-weight: bold">强烈推荐</span><?php endif; ?>
	...
	<div >
		<div class="my_comment">我的评论：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>评论时间：<?php echo ($msg['time']); ?></span></div>
		<div class="style_my"><span style="margin:10px 10px;color:blue;font-weight: bold;font-size: 14px"><?php echo ($msg['comment']); ?></span></div>

		<?php if($msg['merchant_comment']!='' && $msg['merchant_time']): ?><div class="sail_comment"><span>回复时间：<?php echo ($msg["merchant_time"]); ?></span><?php echo str_repeat("&nbsp;",15);?>卖家回复:</div>
			<div class="style_sail" ><span style="margin:10px 10px;color:blue;font-weight: bold;font-size: 14px"><?php echo ($msg["merchant_comment"]); ?></span></div>
	</div>
	<hr><?php endif; ?>
</div>
	</div>
