...
<div class="info_success " >
	...
	<span style="font-size:30px;font-weight:blod;position:relative;top:-10px;">订单信息</span>
	<div>
	<p style="font-size:18px;font-weight:blod">订单编号：<span style="color:orangered;font-size: 20px;font-weight: bold"><?php echo ($m["o_rand"]); ?></span></p>
	<p style="font-size:18px;font-weight:blod">代金券券码：<span style="color:orangered;font-size: 20px;font-weight: bold"><?php echo ($m["o_code"]); ?></span></p>
	</div>
	<br>
	<div class="back">
